        ...
        if (pickup_point_check) {
            ...
            m_map.setOnCameraMoveListener(new GoogleMap.OnCameraMoveListener(){
                ...
                public void onCameraMove(){
                    Log.e("Camera postion change" + "", m_map.getCameraPosition().target + "");
                    CameraPosition target = CameraPosition.builder().target(location_latlng).zoom(14).build();
    ...
    private void drawDirections() throws ExecutionException, InterruptedException {
        ...
        if(destination_place != null){
            ...
            PolylineOptions rectLine = new PolylineOptions().width(3).color(
                    Color.RED);
            Log.e("destination_place route","--------------------->"+directionPoint.size());
            ...
            m_map.addPolyline(rectLine);
        }else{
            Log.e("destination_place null","--------------------->");
        ...
        formCarousel.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(position == 0) {
                    ...
                    mSourceField.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS));
...
// Set up a PlaceSelectionListener to handle the response.
                ...
                if(position == 1) {
                    ...
                    mDestinationField.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS));
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyA848nvP0_O8Jnx5vKnR7KLDYiiujvSWEc");
    ...
    ViewListener viewListener = new ViewListener() {
        ...
        public View setViewForPosition(int i) {
            ...
            if(i == 1) {
                ...
                if (mDestinationField != null) {
                    mDestinationField.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME));
                }
